...
const VertexSelector: React.FC<VertexSelectorProps> = ({ value, onChange }) => {
  const options = [
    { value: 0 as VertexLevel, label: 'V0', description: '정상(두피 거의 안 보임)' },
    { value: 1 as VertexLevel, label: 'V1', description: '약간 감소' },
    { value: 2 as VertexLevel, label: 'V2', description: '감소' },
    { value: 3 as VertexLevel, label: 'V3', description: '넓은 감소' }
  ];
