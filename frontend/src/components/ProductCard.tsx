...
import { HairProduct } from '../api/hairProductApi';
import { toggleFavoriteProduct, selectIsFavorite } from '../store/hairProductSlice';
      ...
      <div className="relative h-48 bg-gray-100 overflow-hidden">
        <img
          ...
          onError={(e) => {
            ...
            target.src = 'https://via.placeholder.com/300x200?text=제품+이미지';
          }}
        />
